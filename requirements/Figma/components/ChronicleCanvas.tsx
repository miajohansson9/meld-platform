...
const mockEntries: LogEntry[] = [
  ...
  },
  {
    ...
    type: 'fragment',
    title: 'Fragment',
    content: 'Data without story is just noise. Story without data is just fiction. The magic happens in the middle.',
    timestamp: '14:22',
    valueTag: 'Insight',
    isPinned: false
  },
            ...
            {Object.entries(groupedEntries).map(([date, entries]) => (
              <div key={date} className="space-y-4">
                ...
                <div className="sticky top-0 z-10 pb-2">
                  <div 
                    className="inline-block px-4 py-2 rounded-full border border-meld-graysmoke/50 backdrop-blur-sm"
                    style={{ 
