...
export const userInterestSchema = z.object({
  ...
  currentSituation: z.string().min(1, 'Please select what best describes you').trim(),
  ...
  motivation: z.string().min(1, 'Please tell us what you want to get out of MELD').trim(),
}).refine((data) => {
