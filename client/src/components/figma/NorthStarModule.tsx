    ...
    <div className="flex h-full">
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="p-8 pb-16">
            ...
            {narrative.chapters.map((chapter, index) => (
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="flex items-center gap-2">
                    {chapter.isEdited && (
                      <span className="text-xs px-2 py-1 bg-meld-sage/20 border border-meld-sage/30 text-meld-ink rounded-full flex items-center gap-1">
          ...
          <div className="meld-cta-strip rounded-lg p-6 bg-meld-sage/10 border border-meld-sage/20">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-meld-ink/70 mb-2">
                  {isDueToday
                    ? "Consider reflecting to refine your North Star"
                    : `Next opportunity to deepen your narrative in ${daysUntilUpdate} days`}
                </p>
                <Button className="bg-meld-sage hover:bg-meld-sage/90 text-white transition-all hover:scale-105">
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button variant="outline">
                      ...
                      History
                      <span className="ml-2 text-xs px-2 py-1 bg-meld-sage/20 border border-meld-sage/30 text-meld-ink rounded-full">
                        v3
                      </span>
                    </Button>
                  </DropdownMenuTrigger>
                          ...
                          >
                            <div className="flex items-center justify-between mb-1">
                              ...
                              <span className={cn(
                                ...
                                index === 0
                                  ? "bg-meld-sage text-white"
                                  : "bg-meld-sage/20 border border-meld-sage/30 text-meld-ink"
                              )}>
                                {index === 0
                                  ? "Current"
      ...
      <div className="w-80 border-l border-gray-200 bg-meld-graysmoke/20 meld-insight-rail h-full overflow-y-auto">
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      {source.count && (
                        <span className="text-xs ml-auto px-2 py-1 bg-meld-sage/20 border border-meld-sage/30 text-meld-ink rounded-full">
                          {source.count}
                        </span>
                      )}
                    </div>
...
export default NorthStarModule;