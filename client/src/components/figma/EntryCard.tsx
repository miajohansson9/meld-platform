        ...
        <div className="p-5">
          ...
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="flex items-center gap-2">
              {entry.isPinned ? (
                <div title="Pinned to Wins Vault">
                  <Star 
            ...
            {entry.tags && entry.tags.length > 0 && (
              <div className="flex gap-2 flex-wrap">
                {entry.tags.map((tag, index) => (
                  <span
                    key={`${tag}-${index}`}
                    className="text-xs px-3 py-1.5 bg-meld-sage/20 text-meld-ink border border-meld-sage/30 rounded-full font-medium"
                  >
                    {tag}
                  </span>
                ))}
