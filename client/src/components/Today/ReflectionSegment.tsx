...
import { Sunset, Calendar, Clock } from 'lucide-react';
...
export function ReflectionSegment({ className, currentHour }: ReflectionSegmentProps) {
  ...
  if (!isAfternoon) {
    return (
      <div className={cn("bg-white rounded-lg border border-meld-graysmoke/50 overflow-hidden", className)}>
        ...
        <div className="bg-meld-sage/5 border-t border-dashed border-meld-sage/20">
          <div className="p-6 space-y-4">
            ...
            <div className="p-3 bg-meld-sage/10 rounded-lg border border-meld-sage/20">
              <p className="text-sm text-meld-ink/60 italic text-center">
                We'll echo a fragment if patterns emerge.
              </p>
            </div>
          </div>
        </div>
        ...
        {showNarrativeBanner && (
          <div className="mx-6 mb-6 p-4 bg-meld-sage/10 rounded-lg border border-meld-sage/20">
